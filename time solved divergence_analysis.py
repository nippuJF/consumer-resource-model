# -*- coding: utf-8 -*-
"""divergence analysis-time solved updated.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/15ClKqTLowUJCsXMuZSB9wcqCDJPcgnxn
"""
...
for method, idx in zip(['Mean', 'AUC', 'DTW'], range(3)):
    ...
    for label, res in results.items():
        if isinstance(res[idx], np.ndarray):
            to_plot = pd.Series(res[idx], index=res[0].index)  # convert AUC numpy array to Series
        else:
            to_plot = res[idx]
